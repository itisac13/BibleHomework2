...
public class Main {
    public static void main(String[] args) {
        ...
        BigDecimal initialPopulationPerSection = Constants.TOTAL_INITIAL_POPULATION.divide(BigDecimal.valueOf(30).add(BigDecimal.ONE), 15, RoundingMode.HALF_UP);
        ...
        while (true) {
            ...
            BigDecimal newDisciplesPerSection = newDisciples.divide(BigDecimal.valueOf(eligibleSectionsCount), 15, RoundingMode.HALF_UP);
